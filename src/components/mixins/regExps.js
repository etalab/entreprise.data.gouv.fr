export default {
  methods: {
    isSiret: function(input) {
      ...
      const siretWithSeparators1 = RegExp(
        /^\d{3}[.\-_ ]?\d{3}[.\-_ ]?\d{3}[.\-_ ]?\d{5}$/
      );
      const siretWithSeparators2 = RegExp(
        /^\d{3}[.\-_ ]?\d{3}[.\-_ ]?\d{3}[.\-_ ]?\d{3}[.\-_ ]?\d{2}$/
      );
      return (
        siret.test(input) ||
        siretWithSeparators1.test(input) ||
        siretWithSeparators2.test(input)
      );
    },
    ...
    isIdAssociation: function(input) {
      const idAssociationImport = RegExp(
