...
module.exports = {
  'Etablissement Page (RNA) displays correct info': function (browser) {
    ...
    browser.assert.containsText(cssHelpers.firstCompanyPanel + cssHelpers.secondElementInPanel, croixRouge.address)
    browser.assert.containsText(cssHelpers.secondCompanyPanel + cssHelpers.secondElementListInPanel, croixRouge.oldRnaId)
  },
  ...
  'Etablissement Page (RNA + SIRENE) displays correct info': function (browser) {
    ...
    browser.assert.containsText(cssHelpers.firstPanelCategorySirene + cssHelpers.secondElementInPanel, school42.address)
    browser.assert.containsText(cssHelpers.secondPanelCategoryRNA + ' > .company__info-list > .company__item:first-of-type > .company__item-value', school42.rnaId)
    browser.end()
  }
}
