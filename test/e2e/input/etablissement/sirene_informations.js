...
module.exports = {
  'Etablissement Page (SIRENE) displays correct info': function (browser) {
    ...
    // Infos are correct
    browser.assert.containsText(cssHelpers.firstCompanyPanel + cssHelpers.secondElementInPanel, bouygues.address)
    browser.assert.containsText(cssHelpers.secondCompanyPanel + cssHelpers.secondElementInPanel, bouygues.sirenSpaced)
    browser.end()
  }
}
