...
module.exports = {
  "Etablissement Page (company) displays Children Etablissements": function(
    browser
  ) {
    browser
  ...
  "Clicking on children etablissement goes to etablissement page": function(
    browser
  ) {
    browser
      ...
      .getText(secondElementLink, function(siret) {
        ...
        browser.assert.urlEquals(
          `${browser.launch_url}etablissement/${siretNoSpaces}`
        );
      });
    browser.end();
  }
